...
namespace Data
{
    static public class Seed
    {
        public static readonly Component[] Data = new Component[] {
                ...
                new HardDrive {Price = 499, Manufacturer = Manufacturer.WD,      SizeInTB = 2, WeightInKg = 2},
                new HardDrive {Price = 449, Manufacturer = Manufacturer.Seagate, SizeInTB = 1, WeightInKg = 1},
                new HardDrive {Price = 799, Manufacturer = Manufacturer.WD,      SizeInTB = 2, WeightInKg = 0},
                new HardDrive {Price = 600, Manufacturer = Manufacturer.Samsung, SizeInTB = 1, WeightInKg = 0},
